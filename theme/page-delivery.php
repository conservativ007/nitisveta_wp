...
<section id="primary">
	<main id="main">
		...
		<div class="container">
			...
			<div class="bg-white px-4 lg:px-10 py-3 lg:py-8 shadow rounded-xl text-center max-w-3xl mx-auto mb-8">
				<div class="font-title text-primary text-xl lg:text-2xl mb-2 lg:mb-5">
					Не понравился товар?
				</div>
				<div class="flex flex-col space-y-4 text-sm lg:text-xl font-light">
					<p>
						Напишите нам, отправьте товар обратно в течении 30-ти дней и мы вернем вам деньги. К сожалению,
						стоимость доставки мы возместить не сможем.
					</p>
				</div>
			</div>
			...
			<div class="bg-white px-4 lg:px-10 py-3 lg:py-8 shadow rounded-xl text-center max-w-3xl mx-auto mb-8">
				...
				<div class='text-sm lg:text-xl font-light'>
					Если вы хотите получить товары, но не видите вашу страну в этом списке, напишите нам. Мы что-нибудь
					придумаем.
				</div>

				<div class="grid lg:grid-cols-3 items-center gap-4 lg:gap-8 mt-8 mb-8">
					...
					<a class="copy-link cursor-pointer btn-border h-[50px]" data-clipboard-text="nitisveta.ru@gmail.com">
				...
				<div class='text-sm lg:text-xl font-light'>
					...
					Так как наши товары, это буквально ручная работа, а не промышленное производство, они требуют
					специфических таможенных документов.
				</div>
			</div>

			<div class="bg-white px-4 lg:px-10 py-3 lg:py-8 shadow rounded-xl text-center max-w-3xl mx-auto mb-8">
				<div class="font-title text-xl lg:text-2xl">Подпишитесь и мы будем отправлять вам на email <br>промо
					коды и
					рассылку с новинками каталога </div>
				<div class="mt-4">
