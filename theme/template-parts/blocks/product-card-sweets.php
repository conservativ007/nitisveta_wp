...
if ($product->get_stock_quantity() > 1 && $product->get_stock_quantity() < 6) {
  ...
  <div class="flex items-center flex-nowrap p-2 lg:p-5 justify-between">
    ...
    <div class="grid grid-cols-1 gap-x-3 gap-y-3 2xl:gap-x-4 2xl:gap-y-5 w-full items-center justify-end">
      <a href="<?php the_permalink(); ?>" class="text-primary font-bold">
        <?php the_title(); ?>
      </a>
