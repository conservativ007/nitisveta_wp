...
function customize_woo_checkout_fields($fields)
{
    ...
    {
        static $chached_cities = null;

        if ($chached_cities !== null) {
            return $chached_cities;
        }

        $json_path = get_template_directory() . '/data/cities-of-BY-KZ-KG-AM.json';
        ...
        $chached_cities = json_decode($json, true);
