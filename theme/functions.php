...
{
	wp_enqueue_style('nitisveta-swiper', get_template_directory_uri() . '/libraries/swiper-bundle.min.css', array(), '', 'all');
	wp_enqueue_style('nitisveta-magnific', get_template_directory_uri() . '/libraries/magnific-popup.css', array(), '', 'all');
	wp_enqueue_style('nitisveta-style', get_stylesheet_uri(), array(), filemtime(get_template_directory() . '/style.css'), 'all');
	wp_enqueue_script('nitisveta-swiper', get_template_directory_uri() . '/libraries/swiper-bundle.min.js', array(), NITISVETA_VERSION, true);
	wp_enqueue_script('nitisveta-magnific', get_template_directory_uri() . '/libraries/jquery.magnific-popup.min.js', array(), NITISVETA_VERSION, true);
	wp_enqueue_script('nitisveta-script', get_template_directory_uri() . '/js/script.min.js', array(), NITISVETA_VERSION, true);

	wp_localize_script('nitisveta-script', 'ajax_object', array('ajax_url' => admin_url('admin-ajax.php')));
...
function custom_override_billing_fields($address_fields)
{
	...
	$address_fields['billing_postcode']['placeholder'] = 'Индекс';
...
function customize_woo_checkout_fields($fields)
{
	...
	$fields['order']['order_comments']['placeholder'] = 'Необязательно. Примечания к вашему заказу';
...
function custom_single_add_to_cart_text() {
	return 'Добавить в корзину'; // Change this to change the text on the Single Product Add to cart button.
}
