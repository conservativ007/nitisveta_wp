...
<div class="yith-wcwl-add-button">
    ...
    <a href="<?php echo esc_url(wp_nonce_url(add_query_arg('add_to_wishlist', $product_id, $base_url), 'add_to_wishlist')); ?>"
        class="<?php echo esc_attr($link_classes); ?> heart-fav-button"
...
?></span>
    ...
    <a href="<?php echo esc_url(wp_nonce_url(add_query_arg('add_to_wishlist', $product_id, $base_url), 'add_to_wishlist')); ?>"
        class="<?php echo esc_attr($link_classes); ?> default-fav-button btn-border cursor-pointer group h-[50px] lg:w-[50px] w-full"
        data-product-id="<?php echo esc_attr($product_id); ?>"
        data-product-type="<?php echo esc_attr($product_type); ?>"
        data-original-product-id="<?php echo esc_attr($parent_product_id); ?>"
        data-title="<?php echo esc_attr(apply_filters('yith_wcwl_add_to_wishlist_title', $label)); ?>" rel="nofollow">
        <svg class="lg:mr-0 mr-3" width="19" height="18" viewBox="0 0 19 18" fill="none"
            ...
            <path
                ...
                fill="#142346" class="group-hover:fill-white" />
        </svg>
