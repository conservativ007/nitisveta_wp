...
<div class="container xl:mt-6">
  <!-- <p class="text-[30px]">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolore, quaerat autem. Labore soluta, nobis illum autem praesentium exercitationem dolor illo atque ipsum in? Reiciendis maxime at sed quo, soluta modi.</p> -->
      ...
      <div class="lg:flex lg:justify-between grid grid-cols-2 lg:gap-0 gap-6 max-w-lg mt-2 xl:mt-5 xl:mb-10">
        ...
        <div class="order-1">
          <a href="<?php echo esc_url($ozon_value); ?>" target="_blank" class="block">
            <img class="w-full max-w-[150px] max-h-[50px] object-cover rounded-[7px]" src="<?php echo get_template_directory_uri(); ?>/images/links/ozon_link.svg" alt="Перейти на Ozon">
          </a>
        </div>
        ...
        <div class="order-2">
          <a href="<?php echo esc_url($yandex_value); ?>" target="_blank" class="block">
            <img class="w-full max-w-[150px] max-h-[50px] object-cover rounded-[7px]" src="<?php echo get_template_directory_uri(); ?>/images/links/yandex_link.svg" alt="Перейти на Yandex">
          </a>
        </div>
        ...
        <div class="order-4 lg:order-3 group relative">
          <div class="custom-share-icon btn-border border-[#142346] share-link cursor-pointer lg:w-[50px] h-[50px] p-0 space-x-3" data-template="share">
            <span class="relative w-[30px] h-[26px] block">
              <img class="absolute inset-0 w-full h-full transition-opacity duration-100 ease-in-out img-default opacity-100" src="<?php echo get_template_directory_uri(); ?>/images/links/share3.svg" alt="Поделиться">
              <img class="absolute inset-0 w-full h-full transition-opacity duration-100 ease-in-out img-hover opacity-0" src="<?php echo get_template_directory_uri(); ?>/images/links/share4.svg" alt="Поделиться">
