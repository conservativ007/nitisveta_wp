    ...
    <div class="col-span-4 bg-white shadow p-3 xl:p-9 flex flex-col relative product-summary">
      ...
      <div class="pb-5 pt-3 xl:pb-7 xl:pt-7 mb-6 xl:mb-8 border-b-2 xl:border-b  border-slate-200 flex xl:items-center flex-col xl:flex-row xl:gap-8 gap-4 relative">
        ...
        <div class="absolute flex items-center justify-center top-1/2 z-20 -right-[60px] -mt-3 rotate-90 w-[120px] xl:hidden">
          <div class="bg-primary text-white flex justify-center items-center h-6 xl:h-9 w-full text-center font-title text-sm xl:text-xl rounded-b-lg z-10">
            уцененный</div>
        </div>
...
?>
      ...
      <div class="lg:flex lg:justify-between grid grid-cols-2 lg:gap-0 gap-6 max-w-lg mt-2 xl:mt-5 xl:mb-10">
        ...
        <a href="<?php echo esc_url($ozon_value); ?>" target="_blank" class="block">
          <img class="w-full min-w-[150px] max-h-[50px] object-cover rounded-[7px]" src="<?php echo get_template_directory_uri(); ?>/images/links/ozon_link.svg" alt="Перейти на Ozon">
        </a>
        <?php else: ?>
        ...
        <a href="<?php echo esc_url($yandex_value); ?>" target="_blank" class="block">
          <img class="w-full min-w-[150px] max-h-[50px] object-cover rounded-[7px]" src="<?php echo get_template_directory_uri(); ?>/images/links/yandex_link.svg" alt="Перейти на Yandex">
        </a>
        ...
        <div class="">
          <div class="btn-border share-link cursor-pointer lg:w-[50px] h-[50px]" data-template="share">
            <img class="lg:block hidden min-w-[30px] min-h-[26px]" src="<?php echo get_template_directory_uri(); ?>/images/links/share.svg" alt="Поделится">
