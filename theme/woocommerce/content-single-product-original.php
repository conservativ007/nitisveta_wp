...
<p class="text-[40px] text-red-800">oroginal</p>
    <div id="product-<?php the_ID(); ?>"
        <?php wc_product_class('xl:grid grid-cols-1 xl:grid-cols-7 xl:gap-3', $product); ?>>
        ...
        <div class="single-product-gallery-wrapper w-full col-span-4 xl:col-span-3 px-0">
            ...
            <div class="swiper mySwiper2 select-none swiper-product bg-white shadow mb-3">
                ...
                <div
                    class="swiper-navigation xl:hidden absolute h-0 top-1/2 px-1 w-full flex items-center justify-between gap-5 z-10">
                    <div class="swiper-sprod-button-prev h-4 w-4 block"><svg width="15" height="17" viewBox="0 0 15 17"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M2 6.76795C0.666667 7.53775 0.666665 9.46225 2 10.2321L10.25 14.9952C11.5833 15.765 13.25 14.8027 13.25 13.2631L13.25 3.73686C13.25 2.19726 11.5833 1.23501 10.25 2.00481L2 6.76795Z"
                                fill="#EF3343" stroke="white" stroke-width="2" />
                        </svg>
                    </div>
                    <div class="swiper-sprod-button-next h-4 w-4 block"><svg width="15" height="17" viewBox="0 0 15 17"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M13 10.2321C14.3333 9.46225 14.3333 7.53775 13 6.76795L4.75 2.00481C3.41667 1.23501 1.75 2.19726 1.75 3.73686L1.75 13.2631C1.75 14.8027 3.41666 15.765 4.75 14.9952L13 10.2321Z"
                                fill="#EF3343" stroke="white" stroke-width="2" />
                        </svg>
                    </div>
                </div>
            ...
            <div thumbsSlider="" class="swiper select-none mySwiper swiper-thumbs relative max-lg:hidden">
                <div class="swiper-wrapper">
                    <div class="swiper-slide h-52 card">
                        ...
                        <img src="<?php echo get_the_post_thumbnail_url($product->ID); ?>"
                            class='object-contain h-full w-full block border-2 border-transparent hover:border-secondary transition cursor-pointer' />
                    </div>
                ...
                <div
                    class="swiper-navigation absolute h-0 top-1/2 px-1 w-full flex items-center justify-between gap-5 z-10">
                    <div class="swiper-thumb-button-prev h-4 w-4 block"><svg width="15" height="17" viewBox="0 0 15 17"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M2 6.76795C0.666667 7.53775 0.666665 9.46225 2 10.2321L10.25 14.9952C11.5833 15.765 13.25 14.8027 13.25 13.2631L13.25 3.73686C13.25 2.19726 11.5833 1.23501 10.25 2.00481L2 6.76795Z"
                                fill="#EF3343" stroke="white" stroke-width="2" />
                    ...
                    <div class="swiper-thumb-button-next h-4 w-4 block"><svg width="15" height="17" viewBox="0 0 15 17"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M13 10.2321C14.3333 9.46225 14.3333 7.53775 13 6.76795L4.75 2.00481C3.41667 1.23501 1.75 2.19726 1.75 3.73686L1.75 13.2631C1.75 14.8027 3.41666 15.765 4.75 14.9952L13 10.2321Z"
                                fill="#EF3343" stroke="white" stroke-width="2" />
        ...
        <div class="col-span-4 bg-white shadow p-3 xl:p-9 flex flex-col relative product-summary">
            ...
            <?php if ($ucenenn) : ?>
            <div
                class="bg-primary text-white flex items-center absolute top-0 right-9 h-9 px-8 font-title text-xl rounded-b-lg max-xl:hidden">
                уцененный</div>
            <?php endif; ?>
            ...
            <p>
                ...
                <span class="text-[40px] text-red-800">original</span>
            </p>

            <div
                class="grid grid-cols-1 xl:grid-cols-3 gap-x-4 text-sm leading-6 pb-7 border-b-2 xl:border-b border-slate-200">
...
?>
            ...
            <div
                class="pb-5 pt-3 xl:pb-7 xl:pt-7 mb-6 xl:mb-8 border-b-2 xl:border-b  border-slate-200 flex xl:items-center flex-col xl:flex-row xl:gap-8 gap-4 relative">

                <?php if ($ucenenn) : ?>
                <div
                    class="absolute flex items-center justify-center top-1/2 z-20 -right-[60px] -mt-3 rotate-90 w-[120px] xl:hidden">
                    <div
                        class="bg-primary text-white flex justify-center items-center h-6 xl:h-9 w-full text-center font-title text-sm xl:text-xl rounded-b-lg z-10">
                        уцененный</div>
                </div>
                ...
                <div class='flex items-center gap-3 max-xl:order-2'>
                    ...
                    <span class='opacity-50 text-lg xl:text-xl font-bold relative xl:top-1/2 inline-block'>
                        <?php echo $regularPrice ?> ₽ <span
                            class="absolute h-[2px] w-full bg-primary top-1/2 left-0"></span>
                    </span>
                    <span
                        class='rounded-md border border-[#E6E2EB] text-sm w-16 h-8 font-bold inline-flex items-center justify-center'>-
...
?>
                ...
                <?php if ($ucenenn) : ?>
                <div class="text-secondary text-sm ucen-link cursor-pointer max-xl:order-3">Почему товар уцененный?
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="pt-1 xl:pt-7 max-w-lg">
                <form class="w-full mb-4" action="<?php echo esc_url(get_permalink()); ?>" method="post"
...
if ($ozon_value):
    ?>
                <a href="<?php echo esc_url($ozon_value); ?>" target="_blank" class="block">
                    <img class="w-full min-w-[150px] max-h-[50px] object-cover rounded-[7px]"
                ...
                <div class="">
                    <div class="btn-border share-link cursor-pointer lg:w-[50px] h-[50px]" data-template="share">
                        <img class="lg:block hidden min-w-[30px] min-h-[26px]"
                            src="<?php echo get_template_directory_uri(); ?>/images/links/share.svg" alt="Поделится">
                        <span class="lg:hidden block">Поделиться</span>
                    </div>
                </div>
            ...
            <div style="display: none;">
                <div id="share">
                    <div class="copy-link flex items-center gap-2 py-1 px-2 rounded hover:bg-white hover:bg-opacity-5 cursor-pointer"
                        data-clipboard-text="<?php echo esc_url(get_permalink()); ?>">
                        <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M13.3525 10.6075C13.3525 12.1235 12.1235 13.3525 10.6075 13.3525H3.745C2.22898 13.3525 1 12.1235 1 10.6075V3.745C1 2.22898 2.22898 1 3.745 1H10.6075C12.1235 1 13.3525 2.22898 13.3525 3.745V10.6075Z"
                                stroke="white" stroke-width="1.40625" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M6.39258 16.0001H13.2551C14.7711 16.0001 16.0001 14.7711 16.0001 13.2551V6.39258"
                                stroke="white" stroke-width="1.40625" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>

                        <span>Скопировать ссылку</span>
                    </div>
                    <a class="flex items-center gap-2 py-1 px-2 rounded hover:bg-white hover:bg-opacity-5"
                        target="_blank" href="https://t.me/share/url?url=<?php echo get_permalink(); ?>">
                        <svg width="15" height="13" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M0.919431 5.32028L9.85562 1.69424C10.7374 1.31653 13.728 0.107851 13.728 0.107851C13.728 0.107851 15.1082 -0.420947 14.9932 0.863276C14.9549 1.39207 14.6481 3.24286 14.3414 5.24765L13.3829 11.1806C13.3829 11.1806 13.3062 12.0494 12.6544 12.2005C12.0027 12.3515 10.9291 11.6717 10.7374 11.5206C10.5841 11.4073 7.86193 9.70756 6.86509 8.87659C6.59671 8.64997 6.28999 8.19671 6.90343 7.66791C8.28368 6.42146 9.9323 4.87284 10.9291 3.89079C11.3892 3.43753 11.8493 2.37994 9.9323 3.66416L4.5234 7.24662C4.5234 7.24662 3.90996 7.62433 2.75976 7.28439C1.60955 6.94445 0.26765 6.49119 0.26765 6.49119C0.26765 6.49119 -0.652512 5.92462 0.919431 5.32028Z"
                                fill="white" />
                        </svg>
                    ...
                    <a class="flex items-center gap-2 py-1 px-2 rounded hover:bg-white hover:bg-opacity-5"
                        target="_blank"
                        href="https://vk.com/share.php?image=<?php echo get_the_post_thumbnail_url($product->ID); ?>&title=<?php echo get_the_title(); ?>&url=<?php echo get_permalink(); ?>">
                        <svg width="15" height="9" viewBox="0 0 15 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M7.33907 8.67315H8.23564C8.23564 8.67315 8.50639 8.64278 8.64483 8.49118C8.77208 8.35183 8.76801 8.09034 8.76801 8.09034C8.76801 8.09034 8.75047 6.86591 9.30873 6.6856C9.85927 6.50787 10.5661 7.86896 11.3151 8.39236C11.8816 8.78831 12.3121 8.70164 12.3121 8.70164L14.3153 8.67315C14.3153 8.67315 15.3632 8.60735 14.8663 7.76881C14.8256 7.70032 14.5768 7.14853 13.3768 6.01484C12.1206 4.82826 12.289 5.02023 13.8021 2.96774C14.7235 1.71778 15.0918 0.95471 14.9767 0.627905C14.8671 0.316528 14.1893 0.398781 14.1893 0.398781L11.9339 0.412973C11.9339 0.412973 11.7665 0.389804 11.6426 0.465282C11.5214 0.539094 11.4436 0.711555 11.4436 0.711555C11.4436 0.711555 11.0865 1.67875 10.6106 2.50143C9.60626 4.23712 9.20462 4.32899 9.04045 4.22104C8.65851 3.96982 8.75396 3.21203 8.75396 2.67352C8.75396 0.991374 9.00464 0.290025 8.2658 0.108479C8.02066 0.0482679 7.84007 0.00843181 7.21304 0.00192692C6.40822 -0.00640584 5.72722 0.00445387 5.34153 0.196752C5.08493 0.324647 4.88696 0.609573 5.0076 0.625969C5.15671 0.646183 5.49423 0.718705 5.67318 0.966537C5.90437 1.28668 5.89629 2.00534 5.89629 2.00534C5.89629 2.00534 6.02914 3.98547 5.58613 4.23136C5.28216 4.40006 4.86509 4.05568 3.96969 2.48095C3.511 1.67434 3.16455 0.782625 3.16455 0.782625C3.16455 0.782625 3.09784 0.616024 2.97868 0.526837C2.83416 0.41878 2.63223 0.384535 2.63223 0.384535L0.488906 0.398781C0.488906 0.398781 0.167232 0.40792 0.0490209 0.55033C-0.0561436 0.677095 0.0406232 0.938958 0.0406232 0.938958C0.0406232 0.938958 1.7185 4.93449 3.61854 6.948C5.36091 8.79433 7.33907 8.67315 7.33907 8.67315Z"
                                fill="white" />
                        </svg>
            ...
            <div class="mt-auto pt-5 max-xl:mt-7 xl:pt-7 border-t border-slate-200 text-sm max-xl:border-t-2">
                Доставка до двери или до пункта выдачи заказов по России, в Беларусь, Армению, Казахстан, Киргизию, <a
                    href="/delivery" class="text-secondary"><span>другие страны</span> <svg class="inline-block"
